...
const Collections = () => {
  const collections = [
    ...
    { title: 'Kalamkari Print Silk Sarees', image: 'https://res.cloudinary.com/duc9svg7w/image/upload/v1761991964/Kalamkari_print_saree_uvhwhn.png' },
    { title: 'Kalamkari Cotton Sarees', image: 'https://res.cloudinary.com/duc9svg7w/image/upload/v1761993092/Jaipur_Cotton_Saree_c4ccke.png' },
  ...
  const pathByTitle = {
    ...
    'Sambalpuri Sarees': '/category/silk/sambalpuri-silk-sarees',
    'Kalamkari Print Silk Sarees': '/category/silk/kalamkari-print-silk-sarees',

    // Cotton
    'Bengali Cotton Sarees': '/category/cotton/bengali-cotton-sarees',
    ...
    'Office Wear Cotton Sarees': '/category/cotton/office-wear-cotton-sarees',
    'Dr.Khadi Cotton Sarees': '/category/cotton/dr-khadi',
    'Block Printed Cotton Sarees': '/category/cotton/block-printed-cotton-sarees',
    'Bagru Print Cotton Sarees': '/category/cotton/bagru-print-cotton-sarees',
    'Ajrakh Print Cotton Sarees': '/category/cotton/ajrakh-print-cotton-sarees',
    'Ikkat Cotton Sarees': '/category/cotton/ikkat-cotton-sarees',
    'Chanderi Cotton Silks': '/category/cotton/chanderi-cotton-silks',
    'Kalamkari Cotton Sarees': '/category/cotton/kalamkari-cotton',

    // Regional
    'Sambalpuri Regional Sarees': '/category/regional/sambalpuri-regional-sarees',
    'Kanjivaram Regional Sarees': '/category/regional/kanjivaram-regional-sarees',
    'Bengali Regional Sarees': '/category/regional/bengali-regional-sarees',
    'Mysore Regional Sarees': '/category/regional/mysore-regional-sarees',
    'Maheshwari Regional Sarees': '/category/regional/maheshwari-regional-sarees',
    'Karnataka Regional Sarees': '/category/regional/karnataka-regional-sarees',
    'Tamilnadu Regional Sarees': '/category/regional/tamilnadu-regional-sarees',
    'Banarasi Regional Sarees': '/category/regional/banarasi-regional-sarees',
